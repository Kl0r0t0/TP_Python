...
def programa_contraeña():
    """El porgrama impide que el usuario continua a no ser que ingrese la contraseña correcta, ademas, el usuario tiene 3 intentos para ingresar la contraseña correctamnete,cada intento fallido aumento el tiempo que el usuario debe esperar para intentar nuevamente el programa devuelve si la contraseña fue ingresada correctamente mediante un valor booleano"""
    contraseña_booleana = False
    intentos = 3
    espera = 4
    ...
    #El programa utiliza la funcion sleep para generear un tiempo de espera el cual aumenta con cada paso del bucle while
        ...
        if (intentos == 0):
            ...
            #Cunado la contraseña es ingresada correctamente el valor booleano del estado de contraseña_booleana, pasa de False a True
            if (verificador == contraseña):
                contraseña_booleana = True
                if (contraseña_booleana == True):
